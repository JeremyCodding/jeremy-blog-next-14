...
export type CreateUpdateBlogUser = {
    email: string,
    blogId: string,
    role: BlogUser['role'],
}
...
export const createBlogUser = async ({data}: {data: CreateUpdateBlogUser}) => {
...
export const deleteBlogUserRole = async ({blogUserId}: {blogUserId: string}) => {
